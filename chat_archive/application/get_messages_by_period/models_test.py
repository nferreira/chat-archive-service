"""Tests for get_messages_by_period models."""
from __future__ import annotations

import pytest
from pydantic import ValidationError

from chat_archive.application.get_messages_by_period.models import (
...
class TestGetMessagesByPeriodResponse:
    def test_valid_response(self):
        resp = GetMessagesByPeriodResponse(
            items=[
                MessageItem(question="Q1", answer="A1", created_at="2025-06-15T12:00:00Z"),
                MessageItem(question="Q2", answer="A2", created_at="2025-06-16T12:00:00Z"),
            ],
            total=2,
            page_size=50,
            page=0,
