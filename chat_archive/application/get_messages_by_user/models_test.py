"""Tests for get_messages_by_user models."""
from __future__ import annotations

import pytest
from pydantic import ValidationError

from chat_archive.application.get_messages_by_user.models import (
...
class TestGetMessagesByUserResponse:
    def test_valid_response(self):
        resp = GetMessagesByUserResponse(
            items=[
                MessageItem(question="Q1", answer="A1", created_at="2025-06-15T12:00:00Z"),
                MessageItem(question="Q2", answer="A2", created_at="2025-06-15T13:00:00Z"),
            ],
            total=2,
            page_size=50,
            page=0,
